...
<html lang="en">
  <head>
    ...
    <title>List Dokter - DocAway</title>

    <link rel="stylesheet" href="css/listdokter.css" />
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                ...
                <a href="detaildokter.php">
                <div class="kotak-dokter">
                    <div class="kotak">
                        <img src="uploads/foto-dokter/happy.jpg">
                        <div class="badan-kotak">
                            <div class="nama-dokter">Dr. Zaki Hatta</div>
